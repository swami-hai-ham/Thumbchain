...
const page = (props: Props) => {
  ...
  return (
    <div className='w-full h-screen flex justify-center items-center overflow-hidden flex-col' ref={divRef}>
      <NavBar/>
      <div className="w-30 h-32 text-primary-foreground text-7xl text-ex mt-48 z-30 flex flex-wrap hero-title1 opacity-0 font-monteserrat font-extrabold">Thumbnails</div>
      <div className="w-30 h-32 text-primary-foreground text-7xl mt-5 text-ex z-30 flex flex-wrap hero-title2 opacity-0 font-monteserrat font-extrabold">That drive results</div>
      <div className="w-30 h-32 text-foreground text-xl mt-10 z-30 subText opacity-0">Get real-time insights on thumbnail performance</div>
      <div className="w-30 h-32 text-foreground text-xl z-30 subText opacity-0">from a diverse pool of users</div>
      <div className="h-24 w-64 bg-[#292929] rounded-xl z-30 absolute hover:before:opacity-100 before:opacity-0 before:transition-opacity before:duration-300 flex justify-center items-center card1 opacity-0 card">
        <div className="text-foreground font-poppins text-xl font-medium">Global Audience</div>  
      ...
      <div className="h-24 w-64 bg-[#292929] rounded-xl z-30 absolute hover:before:opacity-100 before:opacity-0 before:transition-opacity before:duration-300 flex justify-center items-center card2 opacity-0 card">
        <div className="text-foreground font-poppins text-xl font-medium">Increased CTR</div>  
        <div className="absolute bottom-2 left-0 right-0 h-16 overflow-hidden">
          <div className="dots-pattern"></div>
        </div>
      </div>
      <div className="h-24 w-64 bg-[#292929] rounded-xl z-30 absolute hover:before:opacity-100 before:opacity-0 before:transition-opacity before:duration-300 flex justify-center items-center card3 opacity-0 card">
        <div className="text-foreground font-poppins text-xl font-medium">Easy to use</div>  
        <div className="absolute bottom-2 left-0 right-0 h-16 overflow-hidden">
          <div className="dots-pattern"></div>
        </div>
      </div>
