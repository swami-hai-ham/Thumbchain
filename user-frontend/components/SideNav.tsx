  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-foreground font-poppins text-sm">Home</span>
      </Link>
      <Link
        href={"/thumbnail"}
        className="flex justify-center items-center gap-6 sideNavLink opacity-0"
      >
        ...
        <span className="text-foreground font-poppins text-sm">Thumbnail</span>
      </Link>
      <Link
        href={"/survey"}
        className="flex justify-center items-center gap-6 sideNavLink opacity-0"
      >
        ...
        <span className="text-foreground font-poppins text-sm">Survey</span>
      </Link>
    </div>
  );
};
